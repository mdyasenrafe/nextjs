...
const ContactSection = () => {
  ...
  return (
    <section className="mt-20 my-16" id="get-early-acess">
      <div className="pb-10 skip-area">
        <p className="font-bold text-xl">
          We re building an ecosystem where
          <span className="bg-yellow-200"> anyone can get inspired</span>
          ...
          that could
          <span className="bg-yellow-200">change the world.</span>.
        </p>
      </div>
      {show ? (
        <div className="skip-area">
          <h1 className="text-4xl text-green-500">Thank you for interest</h1>
        </div>
      ) : (
        <>
          {loading === true ? (
            ...
            <form className="w-full max-w-sm mt-6 skip-area">
